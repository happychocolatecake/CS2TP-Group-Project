...
<div class="mb-10">
    <h1 class="text-6xl font-normal mb-2 tracking-tight">Product Name</h1>
    <h2 class="text-2xl font-bold mb-6">Brand Name</h2>
    ...
    <div class="flex items-center gap-1">
        ...
        <span class="text-xs text-gray-500">483 Reviews</span>
    </div>
</div>