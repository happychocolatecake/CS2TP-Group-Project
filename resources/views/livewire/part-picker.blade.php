                    ...
                    <div>
                        <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-5 sm:p-6 flex flex-col sm:flex-row justify-between items-center gap-4">
                            ...
                            <div class="w-full sm:w-auto flex flex-col sm:flex-row gap-3">
                                ...
                                @if(count($selected) > 0)
                                    <button wire:click="clearBuild" class="w-full sm:w-auto px-4 py-3 bg-red-50 text-red-600 hover:bg-red-100 font-semibold rounded-lg shadow-sm transition flex items-center justify-center gap-2 border border-red-200">
